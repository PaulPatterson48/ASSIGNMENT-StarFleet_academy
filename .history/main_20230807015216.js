...
function sortStudent() {
  ...
  e.preventDefault();
  document.getElementById('sortingHatCard').value;
...
//   return expelStudent.map(item => ({name:studentName, ship:ship.title, message: ship.message, image: ships.imageUrl, isExpelled: true}))
// }
...
function expelStudent(studentIndex) {
  ...
  expelledStudent.push(expelledStudent);
  renderToDom('studentsContainer', students);
