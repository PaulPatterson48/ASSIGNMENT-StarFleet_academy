...
const renderCards= (array) =>{
  const fleetShips = ""; //Set the domString to empty
  array.forEach((item) =>{
...
const toggleCart =(e)=>{
  ...
  const filterAllShips = (fleetShips) =>{
    const filterShips = starship.filter((s) => s.title === fleetShips)
    cardsOnDom(filterAllShips)
  }

const fleetShips = document.querySelector("#show-button")
