...
function expelledCadet(StudentIndex) {
    const cadet =  students.splice(StudentIndex, 1)[0];
    //console.log(expelledCadet)
    expelledCadet.push({name: cadet, ship: "bird of prey", message: "Today is a good day to die"});
