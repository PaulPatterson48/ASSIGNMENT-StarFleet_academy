...
function shuffleShip() {
  const ships= ['Enterprise', 'Voyager', 'Excalibur', 'Excelsior'];
  return ships.sort(() => Math.random() * ships.length);
}
...
function sortStudent(event) {
  ...
  students.push({ name: studentName, ships: randomShip});
  ...
  students.forEach((student, index) => {
    ...
    cardDiv.innerHTML = `
      <div class="card-body">
        ...
        <p class="card-text">Ship: ${student.ship}</p>
